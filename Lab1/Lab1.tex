...
%____________________________________________________________________________
\begin{document}
\makeheader{Lab 1}{Duke University}
\begin{center}
...
\textbf{Internal Resistance of a Voltmeter}					& \multirow{4}{*}{\textbf{10}} \\
Circuit Diagram												& \\
Actual measurements for $V_M, V_S$, and $R$					& \\
Equation and $R_M$ value									& \\ \hline
\textbf{Ideal vs. Practical DC Ammeter}						& \multirow{4}{*}{\textbf{10}} \\
Circuit Diagram												& \\
Actual measurements for $V_M, V_S,$ and $R$					& \\
Equation and $R_M$ value									& \\ \hline
\textbf{Measurements of Time-Dependent Sources}				& \multirow{3}{*}{\textbf{5}} \\
...
\textbf{Lab Left in Proper Order}							& \textbf{3} \\ \hline
